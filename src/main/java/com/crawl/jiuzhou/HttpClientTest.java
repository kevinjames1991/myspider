...
public class HttpClientTest {
	...
	public void postForm() {
		...
		// 创建httppost
		HttpPost httppost = new HttpPost("https://zhihu.com");
		// 创建参数队列
		List<BasicNameValuePair> formparams = new ArrayList<BasicNameValuePair>();
		formparams.add(new BasicNameValuePair("login", "kevinjames1991"));
		formparams.add(new BasicNameValuePair("password", "czw663662123"));
